...
class SearchResult(BaseModel):
    ...
    collection: Optional[str] = Field(None, description="Collection that was searched")
...
class Collection(BaseModel):
    ...
    embedding_dimension: Optional[int] = Field(None, description="Vector dimension for this collection")
...
class MemoryVectorStoreConfig(VectorStoreConfig):
    ...
    persist_path: Optional[str] = Field(None, description="Path to persist index")
...
class ChromaVectorStoreConfig(VectorStoreConfig):
    ...
    persist_directory: Optional[str] = Field(None, description="Directory to persist Chroma data")
    collection_name: str = Field("documents", description="Default collection name")
    host: Optional[str] = Field(None, description="Chroma server host (for remote)")
    port: Optional[int] = Field(None, description="Chroma server port (for remote)")
...
class RAGConfig(BaseModel):
    ...
    embedding_config: Union[OpenAIEmbeddingConfig, LocalEmbeddingConfig] = Field(..., description="Embedding backend configuration")
    
    vector_backend: str = Field(..., description="Vector store backend type")
    vector_config: Union[MemoryVectorStoreConfig, ChromaVectorStoreConfig, PineconeVectorStoreConfig, WeaviateVectorStoreConfig] = Field(..., description="Vector store backend configuration")
